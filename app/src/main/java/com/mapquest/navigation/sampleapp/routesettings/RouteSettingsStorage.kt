...
class RouteSettingsStorage private constructor(private val sharedPreferences: SharedPreferences) {
     ...
     */
    fun readSystemOfMeasurement(): SystemOfMeasurement = SystemOfMeasurement.valueOf(sharedPreferences.getString(RouteOptionKey.SYSTEM_OF_MEASUREMENT.name, SystemOfMeasurement.METRIC.name))
     ...
     */
    fun readLanguageCode(): String = sharedPreferences.getString(RouteOptionKey.LANGUAGE_CODE.name, NavigationLanguage.FRENCH_FR.getLanguageCode())
